...
values (N'Орехова Виктория Павловна', 5, 500, 5 ); 
insert into Постоянные_клиенты(ФИО_клиента, Количество_посещений, Средняя_потраченная_сумма,Скидка_на_количество_посещений) 
values (N'Юбкин Виталий Георгевич', 4, 400, 4); 
insert
into Постоянные_клиенты(ФИО_клиента, Количество_посещений, Средняя_потраченная_сумма,Скидка_на_количество_посещений) 
values (N'Фомин Олег Валерьевич', 5, 500, 5 ); 
insert into Постоянные_клиенты(ФИО_клиента, Количество_посещений, Средняя_потраченная_сумма,Скидка_на_количество_посещений) 
values (N'Плохов Владислав Альбертович', 7, 700, 7 ); 
insert into Постоянные_клиенты(ФИО_клиента, Количество_посещений, Средняя_потраченная_сумма,Скидка_на_количество_посещений) 
values (N'Юркина Оксана Геннадьевна', 4, 400, 4); 
insert into Постоянные_клиенты(ФИО_клиента, Количество_посещений, Средняя_потраченная_сумма,Скидка_на_количество_посещений) 
values (N'Валькин Павел Викторович', 5, 500, 5 ); 
